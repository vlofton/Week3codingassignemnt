//As an FYI to the Graders, each of the numbered task should be run one at a time. Because of all the "Let" statements if you try to run it all at once. it will throw an error message.
